...
export default function FilterCard() {
  ...
  return (
    <Card className="flex flex-col lg:flex-row w-full gap-4 rounded-xl bg-background p-3 shadow-sm border">
      <div className="flex flex-row items-center gap-3 w-full lg:w-auto overflow-x-auto scrollbar-hide pb-1 lg:pb-0">
        <span className="pl-2 text-sm font-semibold text-muted-foreground shrink-0">
          Shows data:
        </span>
            ...
            <Button
              ...
              className={cn(
                ...
                activeView === option.value
                  ? "bg-primary text-background shadow-sm hover:bg-primary/90 hover:text-background"
      ...
      <Button className="w-full lg:w-auto lg:ml-auto h-10 rounded-lg bg-primary px-6 font-semibold text-background hover:bg-primary/90 shrink-0">
        Apply
      </Button>
    </Card>
  );
